...
\caption{\label{fig:mysced_hh_max} $\hat{c}$ for half hourly max over 503 households for a period of 7 weeks using $k=400$ and $h=0.1$ where $n=2352$.}
\end{figure}
...
As we did above, we can look at where the peaks occur for positive differences. Since the time resolution is courser for these, we can pick out more accurately the day of the peak. There are seven peaks for most of positive differences. It's only the scedasis of the ``Max of Daily Max'' that has 5 peaks and maybe another point of inflexion. For those that have 7 peaks, the $4^{\text{th}}$ and $5^{\text{th}}$ peaks are very close and could arguably be part of the same. First let's look at when each of the peaks occurs (table \ref{tab:pos_diff_sced}). Table \ref{tab:pos_diff_scedd} related the day numbering to the day of the week. Clearly some of these occur in the middle of the week but most occur over weekends and there is not a clear pattern. Given that cumulatively Saturdays and Sundays tend to be most intensive week and Thursdays and Fridays have the least usage thus we would expect a lot of positive differences to peak on Saturday but this would only be the case if we were considering averages. When we consider daily totals, a lot of the peaks do occur on the Saturdays as expected or at least on the weekend but some occur on weekdays too and indiscriminately so. This is because extreme behaviour need not follow peak behaviour and also individual peak behaviour need not follow cumulative peak behaviour. ``Max of Daily Max'' follows individual extreme behaviour as does ``Max of Daily Total''. In contrast the ``Total of Daily Total'' picks out collective peak behaviour along with ``Total of Daily Max''.
...
\hline
 ...
 \hline
1 & 595 & 596-597 & 594-595 & 595-596 \\
2 & 605 & 606 & 603-604 & 605-606 \\
3 & 612 & 614 & 612-614 & 611-612 \\ 
4 & 622 & & 617-619 & 622 \\
5 & 624 & & 624-625 & 624 \\
6 & 634 & 630 & 633-635 & 633-635 \\
...
\hline
 & Total of Daily Total & Max of Daily Max & Max of Daily Total & Total of Daily Total \\
 \hline
1 & Wednesday & Thursday - Friday & Tuesday-Wednesday & Wednesday-Thursday \\
2 & Saturday & Sunday & Thursday-Friday & Saturday - Sunday \\
3 & Saturday & Monday & Saturday-Monday & Friday-Saturday \\ 
4 & Tuesday & & Thursday-Saturday & Tuesday \\
5 & Thursday & & Thursday-Friday & Thursday \\
6 & Saturday & Wednesday & Friday-Sunday & Friday-Sunday \\
