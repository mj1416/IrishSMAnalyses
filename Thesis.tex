...
\textbf{AA} & Adjusted Average & \textbf{PV} & Photovoltaic \\
\textbf{BM} & Block Maxima & \textbf{QQ} & Quantile-Quantile \\
\textbf{BRR} & Bayesian Ridge Regression & \textbf{SD} & Similar Day \\
\textbf{d.f.} & Distribution function & \textbf{STLF} & Short Term Load Forecasts  \\
\textbf{DLM} & Dynamic Linear Model & \textbf{VSTLF} & Very Short Term Load Forecasts  \\
\textbf{DNO} & Distribution Network Operators & \textbf{WA} & Weighted Average \\
\textbf{EVI} & Extreme Value Index & & \\
\textbf{EVT} & Extreme Value Theorem & & \\
...
\textbf{MSP} & Maximum Spacing Product & & \\
