...
def plot_err():
    ...
    plt.plot(range(1,504),LW_AAdj_err,"r",label="$\hat{E}_4$")
    plt.xlim((1,504))
    plt.xticks([])
    plt.ylabel("LW")
    plt.legend(loc="upper left")
    ...
    plt.subplot(4,1,3)
    plt.plot(range(1,504),AA_4err,"k",label="$E_4$")
    plt.plot(range(1,504),AA_AAdj_err,"r",label="$\hat{E}_4$")
    plt.xlim((1,504))
    plt.xticks([])
    plt.ylabel("AA")
    plt.legend(loc="upper left")
    ...
    plt.subplot(4,1,4)
    plt.plot(range(1,504),LR_4err,"k",label="$E_4$")
    plt.plot(range(1,504),LR_AAdj_err,"r",label="$\hat{E}_4$")
    plt.xlim((1,504))
    plt.xticks([])
    plt.ylabel("LR")
    plt.legend(loc="upper left")
    ...
    plt.subplot(5,1,5)
    plt.plot(range(1,504),BR_4err,"k",label="$E_4$")
    plt.plot(range(1,504),BR_AAdj_err,"r",label="$\hat{E}_4$")
    plt.xlim((1,504))
    plt.xlabel("Customers")
    plt.ylabel("BR")
    plt.legend()
    plt.show(loc="upper left")
