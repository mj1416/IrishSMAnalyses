...
axarr[1, 1].plot(max_pos_diff_sum.index, max_pos_diff_sum,'c')
axarr[1, 1].set_title('Max of Daily Total')
axarr[1, 1].set_xlabel("Day")
axarr[1, 0].plot(sum_pos_diff_sum.index, sum_pos_diff_sum,'m')
axarr[1, 0].set_title('Total of Daily Total')
