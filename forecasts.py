...
def plot_forecast(forecast,obs,name,P=4):
    import matplotlib.pyplot as plt
    #
    plt.subplot(7,1,1)
    plt.plot(forecast[forecast.Day==1].HH,forecast[forecast.Day==1][forecast.columns[P]],"r",label=name)
    plt.plot(obs[obs.Day==1].HH,obs[obs.Day==1][obs.columns[P]],'k',label="obs")
    plt.ylabel("Mon")
    plt.xlim((0,49))
    plt.legend(loc="upper left")
    ...
    #
    plt.subplot(7,1,2)
    plt.plot(forecast[forecast.Day==2].HH,forecast[forecast.Day==2][forecast.columns[P]],"r",label=name)
    plt.plot(obs[obs.Day==2].HH,obs[obs.Day==2][obs.columns[P]],'k',label="obs")
    plt.ylabel("Tue")
    plt.xlim((0,49))
    plt.xticks([1,7,13,19,25,31,37,43,48],[" "," "," "," "," "," "," "," "," "])
    #
    plt.subplot(7,1,3)
    plt.plot(forecast[forecast.Day==3].HH,forecast[forecast.Day==3][forecast.columns[P]],"r",label=name)
    plt.plot(obs[obs.Day==3].HH,obs[obs.Day==3][obs.columns[P]],'k',label="obs")
    plt.ylabel("Wed")
    plt.xlim((0,49))
    plt.xticks([1,7,13,19,25,31,37,43,48],[" "," "," "," "," "," "," "," "," "])
    #
    plt.subplot(7,1,4)
    plt.plot(forecast[forecast.Day==4].HH,forecast[forecast.Day==4][forecast.columns[P]],"r",label=name)
    plt.plot(obs[obs.Day==4].HH,obs[obs.Day==4][obs.columns[P]],'k',label="obs")
    plt.ylabel("Thu")
    plt.xlim((0,49))
    plt.xticks([1,7,13,19,25,31,37,43,48],[" "," "," "," "," "," "," "," "," "])
    #
    plt.subplot(7,1,5)
    plt.plot(forecast[forecast.Day==5].HH,forecast[forecast.Day==5][forecast.columns[P]],"r",label=name)
    plt.plot(obs[obs.Day==5].HH,obs[obs.Day==5][obs.columns[P]],'k',label="obs")
    plt.ylabel("Fri")
    plt.xlim((0,49))
    plt.xticks([1,7,13,19,25,31,37,43,48],[" "," "," "," "," "," "," "," "," "])
    #
    plt.subplot(7,1,6)
    plt.plot(forecast[forecast.Day==6].HH,forecast[forecast.Day==6][forecast.columns[P]],"r",label=name)
    plt.plot(obs[obs.Day==6].HH,obs[obs.Day==6][obs.columns[P]],'k',label="obs")
    plt.ylabel("Sat")
    plt.xlim((0,49))
    plt.xticks([1,7,13,19,25,31,37,43,48],[" "," "," "," "," "," "," "," "," "])
    #
    plt.subplot(7,1,7)
    plt.plot(forecast[forecast.Day==7].HH,forecast[forecast.Day==7][forecast.columns[P]],"r",label=name)
    plt.plot(obs[obs.Day==7].HH,obs[obs.Day==7][obs.columns[P]],'k',label="obs")
    plt.ylabel("Sun")
    plt.xlim((0,49))
    plt.xticks([1,7,13,19,25,31,37,43,48],["00:00","03:00","06:00","09:00","12:00","15:00","18:00","21:00","23:30"])
    plt.show()
